...
const styles = StyleSheet.create({
  ...
  repCount: { fontSize: 72, fontWeight: 'bold', color: '#CCFF00' },
  ...
  cancelBtn: { position: 'absolute', bottom: 30, alignSelf: 'center', backgroundColor: '#CCFF00', paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
  cancelText: { color: '#000' },
  text: { color: '#fff', textAlign: 'center', margin: 20 },
  link: { color: '#CCFF00', textAlign: 'center', marginTop: 10, fontSize: 16 },
});