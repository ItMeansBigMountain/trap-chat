...
const styles = StyleSheet.create({
  ...
  primary: { alignItems: 'center', backgroundColor: '#FE2C55', borderRadius: 10, minHeight: 50, justifyContent: 'center', marginTop: 4 },
  primaryText: { color: '#fff', fontSize: 16, fontWeight: '700' }, disabled: { opacity: 0.65 },
  link: { alignItems: 'center', padding: 16 }, linkText: { color: '#FE2C55', fontSize: 14 },
