...
const styles = StyleSheet.create({
  ...
  repCount: { fontSize: 72, fontWeight: 'bold', color: '#4f46e5' },
  ...
  cancelBtn: { position: 'absolute', bottom: 30, alignSelf: 'center', backgroundColor: '#4f46e5', paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
  cancelText: { color: '#fff' },
  text: { color: '#fff', textAlign: 'center', margin: 20 },
  link: { color: '#4f46e5', textAlign: 'center', marginTop: 10, fontSize: 16 },
});